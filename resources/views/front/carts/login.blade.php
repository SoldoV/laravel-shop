        ...
        <div class="row">
            ...
            <div class="col-md-5">
                ...
                <form action="{{ route('cart.login') }}" method="post" class="form-horizontal">
                    ...
                    <div class="row">
                        <button class="btn btn-primary btn-block" style="background-color:#605ca8;" type="submit">Login now</button>
                    </div>
                </form>
                <div class="row"><hr>
            ...
            <div class="col-md-6 col-md-offset-1">
                ...
                <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-primary btn-block" style="background-color:#605ca8;">Register</button>
                    </div>
                </form>
            </div>
        </div>
